...
const translations: Record<Exclude<Locale, 'en'>, Record<string, string>> = {
  ru: {
    ...
    Capabilities: 'Возможности', 'From model to final frame.': 'От модели до финального кадра.', 'Start a project': 'Начать проект', "Let's make it visible.": 'Давайте сделаем это видимым.', 'Tell us what you need.': 'Расскажите, что вам нужно.', 'Share a few details. We reply within one business day.': 'Опишите задачу в нескольких словах. Мы ответим в течение одного рабочего дня.', Name: 'Имя', 'Your name': 'Ваше имя', 'Work email': 'Рабочая почта', Company: 'Компания', 'Company name (optional)': 'Название компании (необязательно)', 'Project brief': 'О проекте', 'What would you like us to create?': 'Что вы хотите создать?', 'Budget / deadline': 'Бюджет / срок', Optional: 'Необязательно', 'Send project brief': 'Отправить заявку', 'Sending…': 'Отправляем…', 'Thank you. Your project brief has been sent.': 'Спасибо. Ваша заявка отправлена.', 'The form could not be sent. Please write to': 'Не удалось отправить форму. Напишите на', 'Your details are used only to reply to this inquiry.': 'Данные используются только для ответа на эту заявку.',
  ...
  de: {
    ...
    Capabilities: 'Kompetenzen', 'From model to final frame.': 'Vom Modell bis zum finalen Bild.', 'Start a project': 'Projekt starten', "Let's make it visible.": 'Machen wir es sichtbar.', 'Tell us what you need.': 'Erzählen Sie uns, was Sie brauchen.', 'Share a few details. We reply within one business day.': 'Teilen Sie uns einige Details mit. Wir antworten innerhalb eines Werktags.', Name: 'Name', 'Your name': 'Ihr Name', 'Work email': 'Geschäftliche E-Mail', Company: 'Unternehmen', 'Company name (optional)': 'Unternehmen (optional)', 'Project brief': 'Projektbeschreibung', 'What would you like us to create?': 'Was sollen wir für Sie erstellen?', 'Budget / deadline': 'Budget / Termin', Optional: 'Optional', 'Send project brief': 'Projektanfrage senden', 'Sending…': 'Wird gesendet…', 'Thank you. Your project brief has been sent.': 'Vielen Dank. Ihre Anfrage wurde gesendet.', 'The form could not be sent. Please write to': 'Das Formular konnte nicht gesendet werden. Schreiben Sie an', 'Your details are used only to reply to this inquiry.': 'Ihre Daten werden nur zur Beantwortung dieser Anfrage verwendet.',
  ...
  fr: {
    ...
    Capabilities: 'Savoir-faire', 'From model to final frame.': 'Du modèle à l’image finale.', 'Start a project': 'Démarrer un projet', "Let's make it visible.": 'Rendons-le visible.', 'Tell us what you need.': 'Parlez-nous de votre besoin.', 'Share a few details. We reply within one business day.': 'Partagez quelques détails. Nous répondons sous un jour ouvré.', Name: 'Nom', 'Your name': 'Votre nom', 'Work email': 'E-mail professionnel', Company: 'Entreprise', 'Company name (optional)': 'Entreprise (facultatif)', 'Project brief': 'Votre projet', 'What would you like us to create?': 'Que souhaitez-vous créer?', 'Budget / deadline': 'Budget / délai', Optional: 'Facultatif', 'Send project brief': 'Envoyer la demande', 'Sending…': 'Envoi…', 'Thank you. Your project brief has been sent.': 'Merci. Votre demande a été envoyée.', 'The form could not be sent. Please write to': 'Le formulaire n’a pas pu être envoyé. Écrivez à', 'Your details are used only to reply to this inquiry.': 'Vos coordonnées servent uniquement à répondre à cette demande.',
